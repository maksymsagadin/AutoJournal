...
const ImportButton: React.FC<ImportButtonProps> = ({ vehicle, onImport }) => {
    ...
    return (
        <Box sx={{m:1}}>
            <Tooltip title='Header values must match the journal entry fields. Service, Mileage, Date, and Notes are required. Please update your file before importing, keep your file in Comma Seperate Value format.'>
